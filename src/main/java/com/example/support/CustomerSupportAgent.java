...
public class CustomerSupportAgent {
     ...
     */
    public Map<String, Object> getCustomerAccount(String customerId, 
     ...
     */
    public Map<String, Object> processPayment(String customerId, 
                                              Object amount, 
                                              Map<String, Object> context) {
        Map<String, Object> result = new HashMap<>();
     ...
     */
    public Map<String, Object> createTicket(String customerId, 
                                           String subject, 
                                           String description, 
                                           String priority, 
                                           Map<String, Object> context) {
     ...
     */
    public Map<String, Object> getTickets(String customerId, 
                                         String status, 
                                         Map<String, Object> context) {
        Map<String, Object> result = new HashMap<>();
        ...
        List<Map<String, Object>> filteredTickets = TICKETS.stream()
            ...
            .filter(t -> normalizedStatus.equals("all") || 
                        t.get("status").equals(normalizedStatus))
            .map(HashMap::new)
     ...
     */
    public Map<String, Object> updateAccountSettings(String customerId, 
                                                     String email, 
                                                     String tier, 
                                                     Map<String, Object> context) {
        Map<String, Object> result = new HashMap<>();
        ...
        if (tier != null) {
            String normalizedTier = tier.substring(0, 1).toUpperCase() + 
     ...
     */
    public Map<String, Object> validateRefundEligibility(String customerId, 
                                                         Map<String, Object> context) {
        Map<String, Object> result = new HashMap<>();
     ...
     */
    public Map<String, Object> processRefund(String customerId, 
                                            Object amount, 
                                            Map<String, Object> context) {
        Map<String, Object> result = new HashMap<>();
