...
Write-Host "Customer Support Multi-Agent System v1.2.1" -ForegroundColor Cyan
...
switch ($choice) {
    ...
    "4" {
        ...
        if ($LASTEXITCODE -eq 0) {
            ...
            Write-Host "Location: target/customer-support-agent-1.2.1.jar"
            Write-Host ""
            Write-Host "To run the JAR:"
            Write-Host "  java -jar target/customer-support-agent-1.2.1.jar"
        } else {
